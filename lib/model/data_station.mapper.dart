...
class DataStationMapper extends ClassMapperBase<DataStation> {
  ...
  static const Field<DataStation, double> _f$temperatureMin24 = Field(
    'temperatureMin24',
    _$temperatureMin24,
    opt: true,
  );
  static double? _$temperatureMax24(DataStation v) => v.temperatureMax24;
  static const Field<DataStation, double> _f$temperatureMax24 = Field(
    'temperatureMax24',
    _$temperatureMax24,
    opt: true,
  );
  static double? _$temperatureSnow(DataStation v) => v.temperatureSnow;
  static const Field<DataStation, double> _f$temperatureSnow = Field(
    'temperatureSnow',
    _$temperatureSnow,
    opt: true,
  );
  static double? _$speedWind(DataStation v) => v.speedWind;
  static const Field<DataStation, double> _f$speedWind = Field(
    'speedWind',
    _$speedWind,
    opt: true,
  );
  static double? _$directionWind(DataStation v) => v.directionWind;
  static const Field<DataStation, double> _f$directionWind = Field(
    'directionWind',
    _$directionWind,
    opt: true,
  );
  static double? _$snowHeight(DataStation v) => v.snowHeight;
  static const Field<DataStation, double> _f$snowHeight = Field(
    'snowHeight',
    _$snowHeight,
    opt: true,
  );
  static double? _$snowNewHeight(DataStation v) => v.snowNewHeight;
  static const Field<DataStation, double> _f$snowNewHeight = Field(
    'snowNewHeight',
    _$snowNewHeight,
    opt: true,
  );
...
mixin DataStationMappable {
  String toJson() {
    return DataStationMapper.ensureInitialized().encodeJson<DataStation>(
      this as DataStation,
    );
  }

  Map<String, dynamic> toMap() {
    return DataStationMapper.ensureInitialized().encodeMap<DataStation>(
      this as DataStation,
    );
  }
  ...
  bool operator ==(Object other) {
    return DataStationMapper.ensureInitialized().equalsValue(
      this as DataStation,
      other,
    );
  }
...
class _DataStationCopyWithImpl<$R, $Out>
  ...
  DataStation $make(CopyWithData data) => DataStation(
    ...
    temperatureMin24: data.get(#temperatureMin24, or: $value.temperatureMin24),
    temperatureMax24: data.get(#temperatureMax24, or: $value.temperatureMax24),
